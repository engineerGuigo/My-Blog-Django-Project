...
def post_list(request):
    ...
    return render(request, 'project/post_list.html', stuff_for_frontend)

def post_detail(request, pk):
    post = get_object_or_404(Post, pk=pk)
    stuff_for_frontend = {'post': post}
    return render(request, 'project/post_detail.html', stuff_for_frontend)
...
def post_draft_list(request):
    ...
    stuff_for_frontend = {'posts': posts}
    return render(request, 'project/post_draft_list.html', stuff_for_frontend)
